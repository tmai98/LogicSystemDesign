...
HD_PWD='C:/Users/Tien/Desktop/full adder/FA_structural_adder/FA_structural_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FA_structural_hw.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FA_structural_hw.tcl -notrace
