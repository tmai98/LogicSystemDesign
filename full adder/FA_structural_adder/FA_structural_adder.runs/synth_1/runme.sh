...
HD_PWD='C:/Users/Tien/Desktop/full adder/FA_structural_adder/FA_structural_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FA_structural_hw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FA_structural_hw.tcl
